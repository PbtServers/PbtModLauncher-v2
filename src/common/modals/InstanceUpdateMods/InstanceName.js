...
const InstanceName = ({
  ...
  const createInstance = async localInstanceName => {
    ...
    const InstanceFullPath = path.join(instancesPath, localInstanceName);

    fse.remove(path.join(InstanceFullPath, 'mods'));
    fse.remove(path.join(InstanceFullPath, 'config'));
